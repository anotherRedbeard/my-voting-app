...
1. Repository and solution setup. Create a .NET solution with one ASP.NET Core Razor Pages app and one test project. Add baseline documentation, `.gitignore`, and configuration structure for feature flags. This blocks all later work.
